...
export function handleDeposit(event: Deposit): void {
    ...
    voter._tokensStakedWithoutDecimals = event.params.newBalance.div(constants.TEN_TO_THE_EIGHTEEN);
...
export function handleWithdraw(event: Withdraw): void {
    ...
    voter._tokensStakedWithoutDecimals = event.params.amountLeft.div(constants.TEN_TO_THE_EIGHTEEN);
